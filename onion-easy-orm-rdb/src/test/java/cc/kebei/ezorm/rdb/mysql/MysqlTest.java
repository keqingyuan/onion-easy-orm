package cc.kebei.ezorm.rdb.mysql;

import cc.kebei.ezorm.core.dsl.Update;
...
import cc.kebei.ezorm.rdb.meta.parser.MysqlTableMetaParser;
import cc.kebei.ezorm.rdb.render.SqlRender;
import cc.kebei.ezorm.rdb.render.dialect.MysqlRDBDatabaseMetaData;
...
public class MysqlTest {
    ...
    public void setup() throws Exception {
        ...
        Connection connection = DriverManager
                .getConnection("jdbc:mysql://localhost:3306/db?useSSL=false", "root","12345");
