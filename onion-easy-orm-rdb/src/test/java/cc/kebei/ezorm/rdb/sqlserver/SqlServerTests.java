package cc.kebei.ezorm.rdb.sqlserver;

import cc.kebei.ezorm.rdb.RDBTable;
import cc.kebei.ezorm.rdb.meta.RDBDatabaseMetaData;
import cc.kebei.ezorm.rdb.meta.parser.SqlServer2012TableMetaParser;
import cc.kebei.ezorm.rdb.render.dialect.MSSQLRDBDatabaseMetaData;
...
public class SqlServerTests {
    ...
    public void setup() throws Exception {
        ...
        Connection connection = DriverManager
                .getConnection("jdbc:sqlserver://192.168.1.9:1433;DatabaseName=db;integratedSecurity=false"
                        , "sa", "db_sqlserver2012");
